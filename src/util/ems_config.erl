...
parse_config(Json, NomeArqConfig) ->
	...
	#config{tcp_listen_address 		= Listen_address,
			 ...
			 tcp_accept_timeout 		= maps:get(<<"tcp_accept_timeout">>, Json, ?TCP_ACCEPT_CONNECT_TIMEOUT),
			 tcp_recv_timeout 			= maps:get(<<"tcp_recv_timeout">>, Json, ?TCP_RECV_TIMEOUT),
			 ...
			 ems_default_service_timeout	= maps:get(<<"ems_default_service_timeout">>, Json, ?EMS_DEFAULT_SERVICE_TIMEOUT),
...
get_default_config() ->
	...
	#config{tcp_listen_address 				= ["127.0.0.1"],
			 ...
			 tcp_allowed_address			= [],
			 tcp_accept_timeout 			= ?TCP_ACCEPT_CONNECT_TIMEOUT,
			 ...
			 cat_host_search				= <<>>,							
			 cat_node_search				= <<>>,
			 ems_default_service_timeout	= ?EMS_DEFAULT_SERVICE_TIMEOUT,
			 ems_hostname 					= Hostname2,
			 ems_host	 					= list_to_atom(Hostname),
			 ems_file_dest					= "",
			 ems_debug						= false
